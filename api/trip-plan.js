...
★ 항공/기차 판별(중요): 문서에 '항공권·전자항공권·항공사·편명·공항·IATA·PNR·탑승·게이트·flight' 중 하나라도 있으면 무조건 flights(항공). 절대 trains에 넣지 마세요.
  '기차·열차·역·호차·철도·승차권·railway·train' 신호가 명확할 때만 trains(기차). 애매하면 항공 우선.
...
- 표기 규칙: 역명·열차번호·편명은 티켓에 적힌 원문 그대로 쓰세요(키릴/로마자 그대로, 예: "БУХОРО 1", "711ФА"). 억지 한글 음역 금지. 이모지·특수기호 금지.
- 도시명(depCity/arrCity)만 한글 표준 표기로: 타슈케트(❌타슈케트), 사마르칸트, 부하라, 알마티, 서울. 오타 없이 정확히.
